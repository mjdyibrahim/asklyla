    ...
    <div class="w-full max-w-md p-8 space-y-6 bg-white rounded shadow-md">
      ...
      <form @submit.prevent="handleSaveSettings">
        <div class="space-y-4">
          ...
          <div>
            <button type="submit" class="w-full px-4 py-2 font-bold text-white bg-teal-500 rounded hover:bg-teal-600">Save Settings</button>
          </div>
        </div>
      </form>
    </div>
...
const handleSaveSettings = () => {
  ...
  console.log('Settings saved:', { username: username.value, email: email.value, password: password.value })
}
</script>
